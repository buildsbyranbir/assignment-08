...
const InstalledAppCard = ({ app, onUninstall }) => (
    <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg bg-white shadow-sm">
        <div className="flex items-center gap-4">
            <img src={app.image} alt={app.title} className="w-16 h-16 object-cover rounded-md bg-gray-200" />
            <div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {installedAppsList.length > 0 ? (
                ...
                <div className="text-center py-16 border-2 border-dashed border-gray-300 rounded-lg">
                    ...
                    <p className="text-slate mt-2">You haven't installed any apps yet. Browse our collection to get started!</p>
                    <Link to="/apps" className="mt-6 inline-block bg-primary text-white px-6 py-2 rounded-lg font-semibold hover:bg-primary-light transition-colors">
                        Browse Apps
                    </Link>
                </div>
            )}
